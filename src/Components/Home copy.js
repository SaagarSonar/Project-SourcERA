    ...
    return (
      <>
        ...
        <div className="body-container">
          <div className="tp-item"><img src={require("./c2.jpg")}/></div>
          <div className="tp-item"><img src={require("./c3.png")}/></div>
          <div className="tp-item"><img src={require("./c4.png")}/></div>
          <div className="tp-item"><img src={require("./c5.png")}/></div>
        </div>
        <h2 className ="training-partners">Placed Students</h2>
        <div className="rowhome">
          <div className="columnhome">
            <div className="cardhome">
              <img src={require("./male.png")}/>
              <p>Name</p>
            </div>
          </div>
